...
namespace Corvallis_Transit.Controls
{
    //
    // Note:
    // This entire class has been copy-pasted from the Xaml_Nav sample project here:
    // 
    //https://github.com/Microsoft/Windows-universal-samples/tree/master/xaml_navigation/CS
    //
